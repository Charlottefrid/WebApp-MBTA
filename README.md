...
**1.The Process**
 ...
 P.S. Although we forked from the main repo, it shows that we cannot compare and pull. So, we forked again and create a new repo, and copied everything from our initial repo to here. 
